...
public class simpleWindow extends JFrame {
    ...
    simpleWindow(){
        ...
        JButton [] downBtnTXT = new JButton[] { new JButton("Записать в файл"),
                                                new JButton("Дописать в файл"),
                                                new JButton("Чтение из файла")};

        JButton [] downBtnDOCX = new JButton[] { new JButton("Записать в файл"),
                                                 new JButton("Дописать в файл"),
                                                 new JButton("Чтение из файла")};

        JButton [] downBtnXLS = new JButton[] { new JButton("Записать в файл"),
                                                 new JButton("Дописать в файл"),
                                                 new JButton("Чтение из файла")};

        JButton [] downBtnCSV = new JButton[] { new JButton("Записать в файл"),
                                                 new JButton("Дописать в файл"),
                                                 new JButton("Чтение из файла")};


        JButton [] buttonsCreateFile = new JButton[]{ new JButton("Формат TXT"),
                                            new JButton("Формат Word"),
                                            new JButton("Формат Excel"),
                                            new JButton("Формат CSV")};

        JButton [] buttonsWriteFile = new JButton[]{ new JButton("Формат TXT"),
                                             new JButton("Формат Word"),
                                             new JButton("Формат Excel"),
                                             new JButton("Формат CSV")};
